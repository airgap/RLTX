...
layout(std140, set = 0, binding = 6) uniform Frame {
  ...
  uvec4 flags2;    // x: flags once misc.y is full, bit 0 sampled local lights, bit 1 mist indoors, bit 3 ripples, bit 4 cloth on characters; y: texture size in texels; z: mip bias as float bits
